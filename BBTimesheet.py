...
st.caption(
    "Reads an Excel workbook with one sheet per employee, calculates hours, detects overlaps, "
    "and produces a PAYE-based pay summary."
)
st.caption("Created by Liju Varghese (Aitechs Solutions)")
